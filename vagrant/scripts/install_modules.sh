...
puppet module install example42/php $dir -version 2.0.25
puppet module install puppetlabs/mysql $dir -version 3.6.1

# MY_MODULE
git clone https://github.com/alexhoma/alexhoma-custom_module.git $dir

# MEMCACHED
puppet module install saz/memcached $dir -version 2.8.1
